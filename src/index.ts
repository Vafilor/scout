...
import { ConfigurationNames } from './configuration/constants';
...
app.whenReady().then(async () => {
  ...
  const store = new Store(resolve(userDataPath, ConfigurationNames.AppSettings));

  database = new Manager(resolve(userDataPath, ConfigurationNames.FileDatabase));
  ...
  imageCache = new ImageCache(
    resolve(userDataPath, ConfigurationNames.ImageCache),
    database.imageCache,
    pool
  );
