...
import { ConfigurationNames, getFfmpegBinaryPath } from './configuration/constants';
...
import FfmpegUtils from './server/ffmpeg-utils';
...
app.whenReady().then(async () => {
  ...
  FfmpegUtils.init(getFfmpegBinaryPath());
